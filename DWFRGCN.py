...
class DWFRGCN(object):
    def __init__(self, data_config, pretrain_data):
        # argument settings
        self.model_type = 'DWFRGCN'
        ...
        *********************************************************
        ...
        """
        if self.alg_type in ['DWFRGCN']:
            self.ua_embeddings, self.ia_embeddings = self._create_DWFRGCN_embed()
...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    if args.pretrain == -1:
        ...
        pretrain_data = None
    model = DWFRGCN(data_config=config, pretrain_data=pretrain_data)
